  ...
  Background:  Check all V2 API
    ...
    * def FLEETID =   '0cc09e46-26ad-4593-803d-c378751381b9'
    * def DEVICE = '862798051445647'
    * def ASSET = '862798051445647'
    * def DRIVERID = '_UNASSIGNED'
    * def IGNITION_ID = 'ignition_2023_06_08_11_23_40_284_862798051445647_p46ch'
  ...
  Scenario:  Test Fleet trips -Daterange
    ...
    And headers { "x-lm-desired-account": "cobli",  "Content-Type": "application/json",  "Authorization": "Basic bGlnaHRtZXRyaWNzX3FhOjhOd1BxUUVBZzA0TExKZmV0UWJvZ1d5M2pkSmxkbnB3bjFrYUI5UHhseHVEbjhrUEkyMjdyMmZwcExWRExJY0Q="}
    When method GET
    Then status 200
    And print response
